...
\begin{itemize}
\item 1.1 Is Unique: Implement an algorithm to determine if a string has all unique
characters. What if you cannot use additional data structures?\\
\textbf{Hints:} \#44, \#777, \#732

\item 1.2 Check Permutation: Given two strings, write a method to decide if one is a
permutation of the other.\\
\textbf{Hints:} \#7, \#84, \#722, \#737

\item 1.3 URLify: Write a method to replace all spaces in a string with '\%20'. You may
...
\item 1.4 Palindrome Permutation: Given a string, write a function to check if it is
...
\item 1.5 One Away: There are three types of edits that can be performed on strings:
